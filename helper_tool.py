...
import utils.nearest_neighbors.lib64.python.nearest_neighbors as nearest_neighbors


class ConfigSemanticKITTI:
    k_n = 16  # KNN
    num_layers = 4  # Number of layers
    num_points = 4096 * 3  # Number of input points, changed from 11
...
class DataProcessing:
    ...
    def get_class_weights(dataset_name):
        ...
        if dataset_name is 'S3DIS':
            ...
            num_per_class = np.array([38036936, 608024, 1107391, 513295, 599, 22750, 199735165, 
                            19155683, 149962519, 1998558, 3728123, 946512])
            """
